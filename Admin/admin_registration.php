...
<section  class="login">
    ...
    <p><b>Already have an account? </b><a class="b" href="admin_login.php"><b>Login</b></a></p>
    </section>
</body>
</html>
...
if(isset($_POST['user_register'])){
 ...
 if($row_count>0){
    ...
    $insert_query="INSERT INTO `admin_table` (adminname,admin_email,admin_password,admin_image,
    admin_ip,admin_address,admin_mobile) VALUES ('$user_username','$user_email','$hash_password',
